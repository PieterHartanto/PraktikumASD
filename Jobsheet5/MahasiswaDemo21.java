...
public class MahasiswaDemo21 {
    public static void main(String[] args) {
        ...
        Mahasiswa21 m4 = new Mahasiswa21("126", "Fajar", "2A", 3.9);
        ...
        System.out.println("Data mahasiswa setelah sorting berdasarkan IPK dengan selection sort (ASC):");
        list.selectionSort();
        list.tampil();

        System.out.println("Data mahasiswa setelah sorting berdasarkan IPK dengan insertion sort (ASC):");
        list.insertionSort();
        list.tampil();
